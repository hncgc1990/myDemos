 ...
 */
public class WhtFiveView extends View{




    public WhtFiveView(Context context) {
        super(context);
        init();
    }
    ...
    public WhtFiveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WhtFiveView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mPath=new Path();
        mPath.quadTo(148,-140,296,0);
        mPath.quadTo(148,140,0,0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(0,0,80,mRedPaint);
        canvas.drawCircle(0,0,30,mBlackPaint);
